...
<body class="font-normal box-content">
    ...
    <nav class="bg-secondary text-secondary fixed md:hidden z-[9999]">
        ...
        <div class="flex items-center h-14">
          <div class="flex justify-between w-screen items-center">
            ...
            <div class="pr-14 flex justify-center">
              <a href="blogse.php"><img src="img/ethio-removebg-preview.png" alt="ethioflag" class="w-7 h-6 mr-3 ml-3"></a>
              <a href="#"><img src="img/usa-removebg-preview.png" alt="usaflag" class="w-7 h-6"></a>
          </div>
          </div>
      ...
      <div id="mobile-menu" class="md:hidden hidden flex justify-center text-primary bg-secondary">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a href="index.html" class="block px-3 pb-2 text-lg font-extrabold text-center">Home</a>
          <a href="apartments.html" class="block px-3 py-2 text-lg font-extrabold text-center">Our Apartments</a>
          <a href="blogs.php" class="block px-3 py-2 text-lg font-extrabold text-center border-b-2 border-pri">News</a>
          <a href="about.html" class="block px-3 py-2 text-lg font-extrabold text-center">About Us</a>
          <a href="contact.html" class="block px-3 py-2 text-lg font-extrabold text-center">Contact Us</a>
        </div>
      </div>
    </nav>
      ...
      <div class="md:flex md:justify-between">
        <span class="flex justify-between items-center">
          <div class="flex bg-white rounded-e-full">
            ...
            <p class="md:text-xl font-titleo mt-6 -ml-2 md:hidden lg:block text-secondary pr-5">Addis Life</p>
          </div>
        </span>
        ...
        <div class="flex mr-6 h-16">
          <ul id="nav" class="absolute md:relative flex lg:text-lg md:text-sm font-bold text-primary items-center">
            <li class="">
              <a id="first" href="index.html" class="nav-link md:ml-6 md:hover:bg-white md:hover:p-5 md:hover:text-secondary rounded-b-2xl duration-500 md:mt-0">
                Home
              </a>
            </li>
            <li class="">
              <a id="second" href="apartments.html" class="nav-link md:ml-6 md:hover:bg-white md:hover:p-5 md:hover:text-secondary rounded-b-2xl duration-500">
                Our Apartments
              </a>
            </li>
            <li class="">
              <a id="second" href="blogs.php" class="border-primary border-b-2 nav-link md:ml-6 md:hover:bg-white md:hover:p-5 md:hover:text-secondary duration-500">
                News
              </a>
            </li>
            <li class="">
              <a id="third" href="about.html" class="nav-link md:ml-6 md:hover:bg-white md:hover:p-5 md:hover:text-secondary rounded-b-2xl duration-500">
                About Us
              </a>
            </li>
            <li class="">
              <a id="fourth" href="contact.html" class="nav-link active md:ml-6 md:mr-5 md:hover:bg-white md:hover:p-5 md:hover:text-secondary rounded-b-2xl duration-500">
                Contact Us
              </a>
            </li>
            <li>
            ...
            <li class="flex">
              <a href="blogse.php"><img src="img/ethio-removebg-preview.png" alt="ethioflag" class="lg:w-7 lg:h-6 w-5 h-4 mr-3 ml-3"></a>
              <a href="#"><img src="img/usa-removebg-preview.png" alt="usaflag" class="lg:w-7 lg:h-6 w-5 h-4"></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <!-- nav ends here -->
  <h1 class="md:text-6xl text-4xl font-titleo font-bold text-center text-secondary pt-28">Whats New?</h1>
    ...
    ?>
        <div class="md:flex justify-around md:pb-20 pb-10">
          <div class="w-1/2 hidden md:block">
            <video src="uploads/<?= $result['video'] ?>" class="w-[80%] mx-auto h-auto rounded-2xl" controls></video>
          </div>
          <div class="md:w-1/2 md:p-0 mr-4 p-4 items-center">
            ...
            <h1 class="md:text-5xl text-3xl text-center md:text-start font-bold font-title text-gray-800 border-b-2 border-gray-500 pb-1"><?php echo $result['title'] ?></h2>
              ...
              <img src="uploads/<?= $result['image'] ?>" alt="whats new" class="w-full h-auto rounded-2xl hover:scale-110 duration-700">
              <p class="text-base text-gray-600 text-end">Uploaded on: <?php echo $result['date'] ?></p>
          </div>
          </div>
          <div class="[100%] md:hidden block p-4">
            <video src="uploads/<?= $result['video'] ?>" class="w-full h-auto rounded-2xl " controls></video>
          </div>
        </div>
    <?php
      }
  ...
  <footer class="font-normal foot text-white bg-secondary pt-4 box-border">
        <div class="grid grid-cols-1 grid-rows-4
            ...
            <div class="col-span-1 row-span-1 
                ...
                <div class="flex justify-center mx-auto">
                    <p class="text-primary font-bold text-2xl ml-2">Addis</p>
                    <p class="text-white font-bold ml-2 text-2xl ">Life</p>
                </div>
            </div>
            <ul class="relative col-span-1 row-span-1 md:mx-auto mt-2 pl-5 md:pl-0 md:pt-8 
                md:flex-col md:justify-center">
                <li class="font-bold">
                    <h1 class="text-2xl font-medium text-primary underline mb-1">
                        Quick Links
                    </h1>
                </li>
                <li class="absolute duration-700 hover:text-xl hover:text-primary font-normal"><a
                        href="index.html">Home</a></li>
                <li class="absolute mt-5 duration-700 hover:text-xl hover:text-primary"><a
                        href="apartments.html">Apartments</li>
                <li class="absolute mt-10 duration-700 hover:text-xl hover:text-primary"><a href="blogs.php">News</a>
                </li>
                <li class="absolute mt-14  duration-700 hover:text-xl hover:text-primary"><a href="about.html">About
                        Us</a></li>
                <li class="absolute mt-16 pt-3 duration-700 hover:text-xl hover:text-primary"><a
            ...
            <ul class="relative col-span-1 row-span-1 md:mx-auto mt-2 pl-5 md:pl-0 md:pt-8
                ...
                <li class="absolute duration-700 hover:text-xl hover:text-primary"><a
                        href="tel:+251930696969">+251930696969</a>
                </li>
                <li class="absolute mt-6 duration-700 hover:text-xl hover:text-primary"><a
                        href="tel:+251930656565">+251930656565</a></a></li>
                <li class="absolute mt-12 duration-700  hover:text-primary"><a
            ...
            <ul class="col-span-1 row-span-1 md:mx-auto mt-2 pl-5 md:pl-0 md:pt-8
                ...
                <li class=""><p>In front of AU <br> Headquarters Addis Ababa,<br> Ethiopia</p></li>
            </ul>
        </div>
        ...
        <div class="flex w-full justify-center">
            <p class=" text-white text-xs md:text-base">
                &copy;Copyright. All right reserved.</p>
        </div>
        ...
        <a href="#" class="flex justify-end pr-4 pb-2 md:pt-0  lg:mt-0 text-white">
            <div
                class="p-2 border border-white rounded-full text-xl flex justify-end hover:bg-white hover:text-primary font-bold hover:scale-110 duration-700">
